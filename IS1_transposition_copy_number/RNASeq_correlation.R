...
corr_table_fc$Strain <- c("C325", "CF13", "C063", "H53", "K091", "K141", "K147", "K209", "K249", "K275")
...
corr_table_fc$numIS1 <- c(12, 5, 3, 8, 6, 66, 7, 22, 8, 8)

# Log2FC are obtained from the DESeq2 raw output
corr_table_fc$log2FC <- c(0.336947239785708, 0.809171651123054, 2.40937390238081, 0.761776685244606, 1.65416578660558, -0.298940862287361, 0.334224576505695, -0.235702742630926, 0.975609714589933, 1.04471306249639)
